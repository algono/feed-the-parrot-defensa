...
\begin{document}
  ...
  \begin{frame}{Skill - Abrir}
    \includegraphics[width=\textwidth]{abrir.png}
  \end{frame}

  \begin{frame}{Skill - Lista de feeds}
    \includegraphics[width=\textwidth]{lista-feeds.png}
  \end{frame}
 
  \begin{frame}{Skill - Leer una feed}
    \only<1>{\includegraphics[width=\textwidth]{leer-feed-decir-no.png}}
    
    \only<2>{\includegraphics[width=\textwidth,trim={0 8cm 0 0},clip]{leer-feed-si-parar.png}}
    
    \only<3>{\includegraphics[width=\textwidth,trim={0 0 0 9cm},clip]{leer-feed-si-parar.png}}
  \end{frame}

  \begin{frame}{Skill - Leer una feed - Demasiado larga}
    \includegraphics[width=\textwidth]{feed-demasiado-larga.png}
  \end{frame}

  \begin{frame}{Skill - Leer una feed - Feed Inválida}
    \includegraphics[width=\textwidth]{feed-invalida.png}
  \end{frame}

  \begin{frame}{Skill - Iniciar sesión}
    \includegraphics[width=\textwidth]{iniciar-sesion.png}
  \end{frame}

  \subsection{App}

  % TODO: Capturas demo app
