...
\begin{document}
  ...
  \begin{frame}[label=rss]{RSS}
    \only<1>
    {
      \includegraphics[width=\textwidth,trim={0 0 9cm 0},clip]{rss-feed-example.png} 
    }
    \only<2>
    {
      \includegraphics[width=\textwidth,trim={0 9cm 9cm 5cm},clip]{rss-feed-example.png} 
      \includegraphics[width=\textwidth,trim={0 0 16cm 16.3cm},clip]{rss-feed-example.png} 
    }
  \end{frame}
